...
| 20-07-2026 | **Panel v2**, a petición de Jordi: nueva sección "Índice de credibilidad, medio a medio" — los 60 medios agrupados por rango de veracidad en desplegables, con buscador, nota y medidor, papel en el registro (origen / desmiente / confirma) y evolución de la nota preparada para las revisiones. El panel pasa a generarse automáticamente con `scripts/panel.py` desde los CSV del registro. |
